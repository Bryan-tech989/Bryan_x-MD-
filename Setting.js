...
* @project_name : Bryan-MD
* @Developer : bryan_x  md
* @Version : v.1.4.9
* @license : Apache-2.0
...
global.owner = process.env.OWNER_NUMBER  || '2348106546983' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
global.timezone  = process.env.TIME_ZONE || 'Nigeria/lagos' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================


//======================[YOUR CHOICE, CHANGE OR LEAVE IT SAME]=====================
global.sudo  =  process.env.SUDO || "2348106546983" ;          // DON'T REMOVE
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'bryan+ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `bryan_x+`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'bryan md',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "bryan-ᴍᴅ" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "\t*⤹★ᴘᴏᴡᴇʀᴇᴅ ʙʏ★⤸ bryan ᴹᴰ* ",
  LANG: process.env.THEME || 'bryan_MD',
